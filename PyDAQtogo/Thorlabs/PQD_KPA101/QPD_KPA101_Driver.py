...
class PQD_KPA101:
    ...
    def get_detector(self):
        ...
        detector = PosAligner.GUISettings.Detectors
    ...
    def mode_seting(self, mode = 'open'):
        ...
        """
        if mode == "open":
            self.kcube.SetOperatingMode(PosAligner.PositionAlignerStatus.OperatingModes.OpenLoop, False)
        elif mode == 'close':
            self.kcube.SetOperatingMode(PosAligner.PositionAlignerStatus.OperatingModes.ClosedLoop, False)
        elif mode == "auto":
            self.kcube.SetOperatingMode(PosAligner.PositionAlignerStatus.OperatingModes.AutoOpenClosedLoop, False) ## need to check
        elif mode == "monitor":
            self.kcube.SetOperatingMode(PosAligner.PositionAlignerStatus.OperatingModes.Monitor, False)
        else:
    ...
    def set_PID(self, P = 1, I = 1, D = 1 ):
        ...
        """
        pid_settings = PosAligner.PositionAlignerPIDParameters()
    ...
    def set_Notch_Filter(self, CF = 60, Q = 0.2, NF_state = True):
        ...
        """
        NF_settings = PosAligner.PositionAlignerNotchFilterParameters()
    ...
    def set_LowPass_Filter(self, Cutoff = 90, LowPass_state = True):
        ...
        """
        LowPass_settings = PosAligner.PositionAlignerLowPassFilterParameters()
    ...
    def set_XY_Feedback_Gain(self, X_gain = 0.11, XGainSense = "Forward",   Y_gain = 0, YGainSense = "Forward"):
        ...
        """
        XY_FBGain_settings = PosAligner.PositionAlignerPosDemandParameters()
...
if __name__ == "__main__":
    ...
    PQD.set_XY_Feedback_Gain(X_gain = 0.1, XGainSense = "Forward",   Y_gain = 0, YGainSense = "Backward")
    ...
    ax.legend(loc= "upper left")
    ax_twin.plot(np.array(DiffY_N), 'b', 
